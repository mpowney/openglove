import { BaseChannel, ChannelMessage, ChannelResponse, ChannelEvent, BaseChannelOptions } from './BaseChannel';
...
export class BlueBubblesChannel extends BaseChannel {
  ...
  constructor(opts: BlueBubblesOpts & BaseChannelOptions) {
    super({ id: opts.id, name: opts.name ?? 'bluebubbles', emitRoles: opts.emitRoles });
    this.opts = opts;
  }
