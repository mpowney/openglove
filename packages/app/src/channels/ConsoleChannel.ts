import { BaseChannel, ChannelMessage, ChannelResponse, ChannelEvent, ChannelRoleType, BaseChannelOptions } from './BaseChannel';
...
export class ConsoleChannel extends BaseChannel {
  ...
  constructor(opts: ConsoleChannelOptions & BaseChannelOptions = {}) {
    super({ id: opts.id, name: opts.name ?? 'console', emitRoles: opts.emitRoles });
